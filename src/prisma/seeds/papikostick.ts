...
const papikostickSeed = async () => {
  ...
  const data = [
    {
      questionIndex: 1,
      options: ["Saya seorang pekerja keras", "Saya bukan seorang pemurung"],
    },
    {
      questionIndex: 2,
      options: [
        "Saya ingin bekerja lebih baik dari yang lain",
        "Saya ingin menekuni pekerjaan yang saya lakukan sampai selesai",
      ],
    },
    {
      questionIndex: 3,
      options: [
        "Saya suka mengatakan pada orang lain apa yang harus saya kerjakan",
        "Saya ingin melakukan sesuatu dengan sebaik mungkin",
      ],
    },
    {
      questionIndex: 4,
    ...
    },
    {
      ...
      options: [
        ...
        "Saya suka bila diperhatikan orang",
      ],
    },
    {
      questionIndex: 6,
    ...
    },
    {
      questionIndex: 7,
      options: [
        "Saya cepat merubah pikiran jika saya rasa hal itu diperlukan",
    ...
    },
    {
      questionIndex: 8,
      options: [
        "Saya suka memberi tahu orang jika mereka membuat salah",
        "Saya suka mengerjakan sesuatu yang baru dan berbeda",
      ],
    },
    {
      questionIndex: 9,
      options: [
        ...
        "Saya suka mengikuti petunjuk yang diberikan kepada saya",
      ],
    },
    {
      questionIndex: 10,
      options: [
        "Saya suka mengikuti petunjuk yang diberikan kepada saya",
        "Saya seorang yang teratur, menaruh semua barang pada tempatnya",
      ],
    },
    {
      questionIndex: 11,
      options: ["Saya berusaha keras", "Saya tidak mudah marah"],
    },
    {
      questionIndex: 12,
      options: [
    ...
    },
    {
      questionIndex: 13,
      options: [
        "Saya suka memberitahukan apa yang harus dikerjakan oleh kelompok",
    ...
    },
    {
      questionIndex: 15,
      options: [
        "Saya suka membantu orang dalam memutuskan sesuatu",
    ...
    },
    {
      questionIndex: 17,
      options: [
        "Saya ingin menyenangkan atasan",
        "Saya menyukai petunjuk rinci dalam menyelesaikan pekerjaan",
      ],
    },
    {
      questionIndex: 18,
      options: [
        "Saya suka berterus terang bila ada orang membuat saya kesal",
    ...
    },
    {
      questionIndex: 19,
      options: [
        "Saya dapat mengorganisasikan suatu pekerjaan dengan baik",
    ...
    },
    {
      questionIndex: 20,
      options: [
        "Dalam kelompok saya lebih suka diam",
        "Saya suka mengerjakan setiap langkah pekerjaan dengan hati-hati",
      ],
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        "Jika memang saya benar, saya akan mempertahankannya",
      ],
    },
    {
      questionIndex: 23,
      options: [
        ...
        "Saya senang diberitahukan bagaimana melakukan suatu pekerjaan",
      ],
    },
    {
      questionIndex: 24,
      options: [
        "Saya banyak berpikir dan merencanakan",
        "Hal-hal yang detail menarik minat saya",
      ],
    },
    {
      questionIndex: 25,
      options: [
        "Saya mengambil keputusan dengan mudah dan cepat",
        "Saya merawat barang-barang saya secara rapi dan teratur",
      ],
    },
    {
      questionIndex: 26,
    ...
    },
    {
      questionIndex: 27,
      options: [
        "Saya hanya ingin melakukan suatu pekerjaan pada suatu saat",
    ...
    },
    {
      questionIndex: 28,
      options: [
        "Saya suka bertanggung jawab untuk kepentingan orang lain",
    ...
    },
    {
      ...
      options: [
        ...
        "Saya tertarik untuk menjadi bagian dari suatu kelompok",
      ],
    },
    {
      questionIndex: 30,
      options: [
        "Saya ingin agar orang-orang mengenal saya dengan baik",
        "Saya seorang bersahabat",
      ],
    },
    {
      questionIndex: 31,
    ...
    },
    {
      ...
      options: [
        ...
        "Saya berpendapat bahwa saya bekerja dengan cepat",
      ],
    },
    {
      questionIndex: 33,
      options: [
        "Saya adalah pribadi yang menyenangkan",
        "Saya selalu berusaha menyelesaikan sesuatu yang saya kerjakan",
      ],
    },
    {
      questionIndex: 34,
      options: [
        "Saya suka menyelesaikan dengan baik suatu pekerjaan yang sulit",
    ...
    },
    {
      questionIndex: 35,
      options: [
        "Saya senang bereksperimen dan mencoba hal-hal baru",
    ...
    },
    {
      ...
      options: [
        ...
        "Saya suka petunjuk terinci dalam melaksanakan suatu pekerjaan",
      ],
    },
    {
      questionIndex: 37,
      options: [
        "Saya selalu berusaha menyelesaikan pekerjaan secara sempurna",
        "Saya mudah berteman",
      ],
    },
    {
      questionIndex: 38,
      options: ["Saya banyak berpikir", "Saya bekerja dengan cepat dan mantap"],
    },
    {
      questionIndex: 39,
      options: [
        "Saya mempunyai banyak tenaga untuk berolahraga dan bermain",
        "Saya adalah seorang yang mempunyai pembawaan tenang",
      ],
    },
    {
      questionIndex: 40,
      options: [
        "Saya ingin berteman dengan orang baru dan melakukan hal baru",
        "Saya biasanya mempertahankan pendapat yang saya yakini",
      ],
    },
    {
      questionIndex: 41,
      options: [
        "Saya suka saran-saran dari orang yang saya hormati",
    ...
    },
    {
      ...
      options: [
        ...
        "Apabila saya berbicara, orang-orang akan mendengarkan",
      ],
    },
    {
      questionIndex: 43,
      options: ["Saya lamban dalam mengambil keputusan", "Saya suka membaca"],
    },
    {
      questionIndex: 44,
      options: [
        "Saya biasanya makan dengan cepat",
        "Saya senang pada pekerjaan yang membutuhkan ketelitian",
      ],
    },
    {
      questionIndex: 45,
      options: [
        "Saya suka pekerjaan dimana saya dapat berkeliling/mobile",
        "Saya mencari banyak teman sebanyak mungkin",
      ],
    },
    {
      questionIndex: 46,
      options: [
        ...
        "Saya memusatkan perhatian pada satu persoalan sampai berhasil terpecahkan",
      ],
    },
    {
      questionIndex: 47,
      options: [
        "Saya ingin berhasil",
        "Saya senang orang lain membuat keputusan untuk kelompok",
      ],
    },
    {
      questionIndex: 48,
      options: ["Saya selalu berusaha keras", "Saya selalu tergesa-gesa"],
    },
    {
      questionIndex: 49,
      options: [
    ...
    },
    {
      ...
      options: [
        ...
        "Saya sangat ramah terhadap orang",
      ],
    },
    {
      questionIndex: 51,
    ...
    },
    {
      questionIndex: 52,
      options: [
        "Saya suka mengikuti orang yang saya kagumi",
        "Saya suka mengikuti petunjuk-petunjuk yang jelas",
      ],
    },
    {
      questionIndex: 53,
    ...
    },
    {
      questionIndex: 54,
      options: [
        "Saya mengambil keputusan dengan cepat",
        "Saya biasa bekerja tergesa-gesa",
      ],
    },
    {
      questionIndex: 55,
      options: ["Saya cepat merasa lelah", "Saya banyak membuat persahabatan"],
    },
    {
      questionIndex: 56,
      options: [
    ...
    },
    {
      questionIndex: 57,
      options: [
        "Saya suka mengerjakan sesuatu sampai pada hal yang sekecil-kecilnya",
    ...
    },
    {
      questionIndex: 58,
      options: [
        "Saya senang diberikan petunjuk tentang apa yang harus dikerjakan",
    ...
    },
    {
      ...
      options: [
        ...
        "Saya menaruh barang pada tempatnya",
      ],
    },
    {
      questionIndex: 60,
    ...
    },
    {
      questionIndex: 63,
      options: [
        "Saya menyimpan segala sesuatu ditempatnya",
        "Saya senang pada pekerjaan yang membutuhkan ketepatan",
      ],
    },
    {
      questionIndex: 64,
    ...
    },
    {
      questionIndex: 66,
      options: [
        "Saya berlatih/berolahraga secara teratur",
        "Saya tidak suka menjumpai orang",
      ],
    },
    {
      questionIndex: 67,
      options: [
        "Saya suka memusatkan perhatian pada satu persoalan",
        "Saya suka mengerjakan sesuatu sampai pada hal yang sekecil-kecilnya",
      ],
    },
    {
    ...
    },
    {
      ...
      options: [
        "Saya merasa terganggu bila ada yang tidak menyukai saya",
        "Saya suka mencoba pekerjaan yang baru dan berbeda",
      ],
    },
    {
      questionIndex: 77,
    ...
    },
    {
      questionIndex: 81,
      options: [
        "Saya berusaha untuk lebih akrab dengan orang lain",
        "Saya senang diberitahukan bagaimana melakukan suatu pekerjaan",
      ],
    },
    {
